...
Test tests[NUM_TESTS] = {
	...
	// {{0x00,0xff, 0x01,0xff, 0x02,0x10, 0x03,0x01, 0x04,0x00, 0x05,0x0c, 0x20,0x03, 0xa1,0x00, 0xa2,0x00, 0x92,0x00, 0x80,0x45, 0xe2,0x00}, 0x00}, // stress test 0xff*0xff*0x10 loops
};
